...
import svgPaths from "../../imports/svg-9ix4hjxnfm";
...
interface InPersonVerificationCardProps {
  status: string;
  comments: string;
  documents: Document[];
  submittedBy: string;
...
export default function InPersonVerificationCard({
  status,
  comments,
  documents,
  submittedBy,
