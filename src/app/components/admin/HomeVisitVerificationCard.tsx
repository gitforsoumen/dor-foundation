...
import svgPaths from "../../imports/svg-bg2j4q8y4b";

interface HomeVisitVerificationCardProps {
  status: string;
  comments: string;
  document: {
    name: string;
...
export default function HomeVisitVerificationCard({
  status,
  comments,
  document,
  submittedBy,
  ...
  onDownloadDocument,
  onDeleteDocument,
}: HomeVisitVerificationCardProps) {
