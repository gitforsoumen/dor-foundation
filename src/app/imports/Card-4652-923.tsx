import svgPaths from "./svg-bg2j4q8y4b";
...
function Container() {
  return (
    <div className="h-[53.5px] relative shrink-0 w-[274.95px]" data-name="Container">
...
function Paragraph2() {
  return (
    <div className="h-[91px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[#4d4b48] text-[14px] top-[-0.6px] w-[340px]">{`Home visit confirmed the student's financial need. Family living in modest conditions. Student has a dedicated study space. Neighbors provided positive feedback.`}</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px]">Home_Visit_Photos.pdf</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] top-[-1.2px] w-[217px]">18 Jan 2024 at 02:45 PM • PDF • 1.2 MB</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] text-nowrap top-[-1.2px]">18 Jan 2024</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[362.3px] items-start left-[24px] top-[44.9px] w-[340px]" data-name="Container">
      <Container2 />
      <Container8 />
      <Container9 />
    </div>
...
function Button3() {
  return (
    <div className="absolute h-[21px] left-[24px] top-[425.6px] w-[340px]" data-name="Button">
...
function Button4() {
  return (
    <div className="absolute bg-white border-[#1a4d8f] border-[0.8px] border-solid h-[44px] left-[24px] rounded-[100px] top-[458.6px] w-[340px]" data-name="Button">
...
function StudentProfileDetails1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[388px]" data-name="StudentProfileDetails">
