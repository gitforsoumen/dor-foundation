import svgPaths from "./svg-tjka0bdhjx";
...
function StudentProfileDetails() {
  return (
    <div className="h-[53.5px] relative shrink-0 w-[340px]" data-name="StudentProfileDetails">
...
function StudentProfileDetails1() {
  return (
    <div className="bg-[#d1fae5] h-[28.5px] relative rounded-[6px] shrink-0 w-[89.425px]" data-name="StudentProfileDetails">
...
function StudentProfileDetails2() {
  return (
    <div className="h-[339.55px] relative shrink-0 w-[340px]" data-name="StudentProfileDetails">
...
function StudentProfileDetails3() {
  return (
    <div className="h-[21px] relative shrink-0 w-[340px]" data-name="StudentProfileDetails">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Wix_Madefor_Text:Bold',sans-serif] font-bold leading-[21px] left-[170.89px] text-[#1a4d8f] text-[14px] text-center text-nowrap top-[-0.4px] translate-x-[-50%]">{`Update status, comments & documents`}</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-white h-[44px] relative rounded-[100px] shrink-0 w-[340px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[20.8px] py-[8.8px] relative size-full">
...
export default function Card() {
  return (
    <div className="bg-white relative rounded-[10px] size-full" data-name="Card">
      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[40.4px] items-start pb-[0.8px] pl-[24.8px] pr-[0.8px] pt-[24.8px] relative size-full">
