import svgPaths from "./svg-6bieymitgs";

function PrimitiveH() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[550.4px]" data-name="Primitive.h2">
...
function PrimitiveP() {
  return (
    <div className="h-[21px] relative shrink-0 w-[550.4px]" data-name="Primitive.p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px]">Please provide the final status and feedback for this home visit verification</p>
      </div>
    </div>
  );
}
...
function DialogHeader() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[65px] items-start left-[24px] top-[24px] w-[550.4px]" data-name="DialogHeader">
      <PrimitiveH />
      <PrimitiveP />
    </div>
  );
...
function HomeVisitVerificationForm() {
  return (
    <div className="absolute h-[21px] left-[103.66px] top-0 w-[5.8px]" data-name="HomeVisitVerificationForm">
...
function HomeVisitVerificationForm1() {
  return (
    <div className="absolute h-[21px] left-[80.75px] top-0 w-[5.8px]" data-name="HomeVisitVerificationForm">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#ef4444] text-[14px] text-nowrap top-[-0.4px]">*</p>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="h-[109.6px] relative rounded-[8px] shrink-0 w-full" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[14px] text-[rgba(77,75,72,0.5)] text-nowrap">Enter your comments or feedback</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f2] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[144.2px] items-start relative shrink-0 w-full" data-name="Container">
      <PrimitiveLabel1 />
      <TextArea />
    </div>
  );
...
function HomeVisitVerificationForm2() {
  return (
    <div className="absolute h-[21px] left-[128.45px] top-0 w-[67.65px]" data-name="HomeVisitVerificationForm">
...
function HomeVisitVerificationForm3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[452.4px] items-start left-[24px] overflow-clip pb-0 pt-[16px] px-0 top-[105px] w-[550.4px]" data-name="HomeVisitVerificationForm">
      <Container />
      <Container1 />
      <Container3 />
    </div>
...
function HomeVisitVerificationForm4() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[60.8px] items-start justify-end left-[24px] pb-0 pt-[16.8px] px-0 top-[573.4px] w-[550.4px]" data-name="HomeVisitVerificationForm">
...
export default function PrimitiveDiv() {
  return (
    <div className="bg-white border-[#e2e8f2] border-[0.8px] border-solid relative rounded-[12px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-full" data-name="Primitive.div">
      <DialogHeader />
      <HomeVisitVerificationForm3 />
      <HomeVisitVerificationForm4 />
      <PrimitiveButton1 />
    </div>
  );
}