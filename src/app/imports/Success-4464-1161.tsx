import svgPaths from "./svg-xybjfg97jh";
...
function PrimitiveP() {
  return (
    <div className="h-[45px] relative shrink-0 w-[382.4px]" data-name="Primitive.p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[22.5px] left-[191.7px] text-[#4d4b48] text-[15px] text-center top-[-0.4px] translate-x-[-50%] w-[318px]">Your counselling feedback has been recorded successfully.</p>
      </div>
    </div>
  );
}
