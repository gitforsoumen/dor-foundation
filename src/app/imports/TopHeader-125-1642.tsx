import svgPaths from "./svg-jzfvyro8gg";
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[normal] relative shrink-0 text-[14px] w-[89px]">
      ...
      <p className="font-['Wix_Madefor_Text:Regular',sans-serif] font-normal relative shrink-0 text-[#4d4b48] w-full">Admin</p>
    </div>
  );
}
...
export default function TopHeader() {
  return (
    <div className="bg-white relative size-full" data-name="Top Header">
