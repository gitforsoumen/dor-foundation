import svgPaths from "./svg-fir40mit48";
...
function StudentProfileDetails1() {
  return (
    <div className="absolute bg-[#d1fae5] h-[28.5px] left-[24.8px] rounded-[6px] top-[98.5px] w-[86.363px]" data-name="StudentProfileDetails">
      <Text />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p11405900} id="Vector" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p9461b80} id="Vector_2" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M6.66634 6H5.33301" id="Vector_3" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6663 8.66602H5.33301" id="Vector_4" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6663 11.334H5.33301" id="Vector_5" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Text2() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] text-nowrap top-[-0.4px]">Submitted by: Volunteer Name</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] h-[58px] items-start pb-[10px] pt-[10.8px] px-0 relative shrink-0 w-full" data-name="Container">
...
function StudentProfileDetails2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[264px] items-start left-[24.8px] top-[147px] w-[340px]" data-name="StudentProfileDetails">
      <Container />
      <Container2 />
      <Container3 />
    </div>
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex h-[44px] items-center justify-center left-[24.8px] px-[20.8px] py-[8.8px] rounded-[100px] top-[461.3px] w-[340px]" data-name="Button">
      ...
      <p className="font-['Wix_Madefor_Text:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#1a4d8f] text-[14px] text-center text-nowrap">View Form</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[24.8px] rounded-[100px] top-[417px]" data-name="Button">
      <p className="font-['Wix_Madefor_Text:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#1a4d8f] text-[14px] text-center text-nowrap">
        Update status, comments<span>{` & documents `}</span>
      </p>
    </div>
  );
}
...
function StudentProfileDetails3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[53.5px] items-start left-[25px] top-[24.9px] w-[340px]" data-name="StudentProfileDetails">
      <Heading1 />
      <Paragraph4 />
    </div>
  );
...
function StudentProfileDetails4() {
  return (
    <div className="absolute bg-[#d1fae5] h-[28.5px] left-[25px] rounded-[6px] top-[98.6px] w-[86.363px]" data-name="StudentProfileDetails">
      <Text4 />
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[91px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[#4d4b48] text-[14px] top-0 w-[320px]">Student demonstrated strong academic commitment and clear career goals. Family is very supportive. Recommended for scholarship.</p>
    </div>
  );
}
...
function StudentProfileDetails5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[286px] items-start left-[25px] top-[147px] w-[340px]" data-name="StudentProfileDetails">
      <Container4 />
      <Container8 />
      <Container9 />
    </div>
...
function Button2() {
  return (
    <div className="absolute bg-white content-stretch flex h-[44px] items-center justify-center left-[28.01px] px-[20.8px] py-[8.8px] rounded-[100px] top-[497.3px] w-[340px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#1a4d8f] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <p className="font-['Wix_Madefor_Text:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#1a4d8f] text-[14px] text-center text-nowrap">View Form</p>
    </div>
  );
...
function Button3() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[28.01px] rounded-[100px] top-[453px]" data-name="Button">
      <p className="font-['Wix_Madefor_Text:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#1a4d8f] text-[14px] text-center text-nowrap">
        Update status, comments<span>{` & documents `}</span>
      </p>
    </div>
...
export default function AfterVerificationSubmission() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative size-full" data-name="After verification submission">
      <Card />
      <Card1 />
    </div>
  );
