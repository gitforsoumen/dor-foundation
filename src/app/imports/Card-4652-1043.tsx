import svgPaths from "./svg-9ix4hjxnfm";
...
function Container() {
  return (
    <div className="h-[53.5px] relative shrink-0 w-[222.738px]" data-name="Container">
...
function Paragraph2() {
  return (
    <div className="h-[68.25px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[#4d4b48] text-[14px] top-[-0.6px] w-[324px]">Student demonstrated strong academic commitment and clear career goals. Family is very supportive. Recommended for scholarship.</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px]">Verification_Report.pdf</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] top-[-1.2px] w-[220px]">15 Jan 2024 at 10:30 AM • PDF • 423 KB</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px]">Additional_Notes.pdf</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] top-[-1.2px] w-[216px]">15 Jan 2024 at 11:15 AM • PDF • 256 KB</p>
    </div>
  );
}
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p1917ed00} id="Vector" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p28db2b80} id="Vector_2" stroke="var(--stroke-0, #1A4D8F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
...
function Container13() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[293px] items-start relative shrink-0 w-full" data-name="Container">
      <Container7 />
      <Container12 />
    </div>
  );
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[319px] items-start relative shrink-0 w-full" data-name="Container">
      <Paragraph3 />
      <Container13 />
    </div>
  );
...
function Paragraph11() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#969696] text-[12px] text-nowrap top-[-1.2px]">15 Jan 2024</p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[490.05px] items-start left-[24px] top-[44.9px] w-[340px]" data-name="Container">
      <Container2 />
      <Container14 />
      <Container15 />
    </div>
...
function Button6() {
  return (
    <div className="absolute h-[21px] left-[24px] top-[553.35px] w-[340px]" data-name="Button">
...
function Button7() {
  return (
    <div className="absolute bg-white border-[#1a4d8f] border-[0.8px] border-solid h-[44px] left-[24px] rounded-[100px] top-[586.35px] w-[340px]" data-name="Button">
...
function StudentProfileDetails1() {
  return (
    <div className="h-[654.35px] relative shrink-0 w-[388px]" data-name="StudentProfileDetails">
