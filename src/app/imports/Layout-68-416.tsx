import svgPaths from "./svg-3d6o1uwxhj";
...
function Container() {
  return (
    <div className="h-[60px] relative shrink-0 w-[62px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[15px] h-[60px] items-center relative w-[62px]">
  ...
  return (
    <div className="bg-white relative size-full" data-name="Layout">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between pb-[0.8px] pt-0 px-[20px] relative size-full">
          <Container />
          <Container3 />
        </div>
      </div>
