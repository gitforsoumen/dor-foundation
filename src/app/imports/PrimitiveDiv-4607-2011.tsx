import svgPaths from "./svg-yadn9thm77";
...
function PrimitiveP() {
  return (
    <div className="h-[21px] relative shrink-0 w-[550.4px]" data-name="Primitive.p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px]">Please provide the final status and feedback for this verification</p>
      </div>
    </div>
  );
}
...
function InPersonVerificationForm() {
  return (
    <div className="absolute h-[21px] left-[103.66px] top-0 w-[5.8px]" data-name="InPersonVerificationForm">
...
function InPersonVerificationForm1() {
  return (
    <div className="absolute h-[21px] left-[80.75px] top-0 w-[5.8px]" data-name="InPersonVerificationForm">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#ef4444] text-[14px] text-nowrap top-[-0.4px]">*</p>
    </div>
  );
}
...
function InPersonVerificationForm2() {
  return (
    <div className="absolute h-[21px] left-[128.45px] top-0 w-[67.65px]" data-name="InPersonVerificationForm">
...
function InPersonVerificationForm3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[452.4px] items-start left-[24px] overflow-clip pb-0 pt-[16px] px-0 top-[105px] w-[550.4px]" data-name="InPersonVerificationForm">
      <Container />
      <Container1 />
      <Container3 />
    </div>
...
function InPersonVerificationForm4() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[60.8px] items-start justify-end left-[24px] pb-0 pt-[16.8px] px-0 top-[573.4px] w-[550.4px]" data-name="InPersonVerificationForm">
...
export default function PrimitiveDiv() {
  return (
    <div className="bg-white border-[#e2e8f2] border-[0.8px] border-solid relative rounded-[12px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-full" data-name="Primitive.div">
      <DialogHeader />
      <InPersonVerificationForm3 />
      <InPersonVerificationForm4 />
      <PrimitiveButton1 />
    </div>
  );
}