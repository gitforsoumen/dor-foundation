function PersonalDetailsStep() {
  return (
    <div className="absolute h-[21px] left-[74.21px] top-0 w-[5.8px]" data-name="PersonalDetailsStep">
...
function PrimitiveLabel() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Wix_Madefor_Text:SemiBold',sans-serif] font-semibold leading-[21px] left-0 text-[#4d4b48] text-[14px] text-nowrap top-[-0.4px] whitespace-pre">Full Name</p>
      <PersonalDetailsStep />
    </div>
  );
}
    ...
    <div className="bg-white h-[56px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[56px] items-center px-[15px] py-[4px] relative w-full">
          <p className="font-['Wix_Madefor_Text:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#969696] text-[14px] text-nowrap whitespace-pre">Koushik Das</p>
        </div>
      </div>
